...
import BrandLogo from "../../assets/LEGALaiselogowithname_ldsc.svg"; //import { SparkleFilled } from "@fluentui/react-icons";
                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <img src={BrandLogo} alt="Chat logo" className={styles.chatIcon} aria-label="Brand logo" />
